...
void MainWindow::init()
{
    ...
    mRenderWindowContainer->setMouseTracking(true);
...
{
    mRenderWindow->Wireframe();
}


void MainWindow::on_actionShaded_Wireframe_triggered()
{
    mRenderWindow->Shaded();
}
...
void MainWindow::on_pushButton_2_clicked()
{
    ...
    ui->pushButton_2->setText("             PLAYING              ");
...
// Reset knappen under "File/Reset"
